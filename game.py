...
class ConnectFourGame:
    def _init_(self, screen, width, height, use_ai=True):
        ...
        self.ai_vs_ai_speed = 0.8  # ثانية بين الحركات
        ...
        self.colors = {
            ...
            'player2': (46, 204, 113),
            'ai': (155, 89, 182),
            'ai_vs_ai': (241, 196, 15),  # لون جديد لوضع AI ضد AI
            'text': (255, 255, 255)
        }
    ...
    def reset(self):
        ...
        # إعادة تشغيل AI ضد AI إذا كان مفعلاً
    ...
    def make_move(self, col):
        ...
        if self.check_winner(self.current_player):
            ...
            # في وضع AI ضد AI، لا نحتاج لبدء التفكير يدوياً
            if not self.ai_vs_ai_mode:
                # إذا كان دور الـAI العادي، نبدأ التفكير
